...
var type_arr = {image: {def: ['圖片', 'image'], opt: ['相片', '漫畫', 'picture', 'comic', 'CG']}, video: {def:['影片', 'video'], opt: ['電影', 'movie', '動畫', 'anime', 'cartoon', 'OVA', '連續劇', '短片']}, music: {def: ['音樂', 'music'], opt: ['歌曲', 'song']}, doc: {def: ['文件', 'doc'], opt: ['書籍', 'book', '小說', 'novel']}, present: {def: ['簡報', 'presentation'], opt: ['投影片']}, sheet: {def: ['試算表', 'sheet'], opt: ['報表']}, rawdoc: {def: ['純文字', 'doc'], opt: ['書籍', 'book', '小說', 'novel', '程式碼', 'code', '網頁', 'web']}, url: {def: ['url', '網站'], opt: ['webpage', '論壇', 'youtube']}};
