...
var type_arr = {image: {def: ['圖片', 'image'], opt: ['相片', 'photo', '漫畫', 'comic']}, zipbook: {def: ['圖片集', 'image book'], opt: ['相片', 'photo', '漫畫', 'comic']}, video: {def:['影片', 'video'], opt: ['電影', 'movie', '動畫', 'anime', 'cartoon', '電視劇', 'tv show']}, music: {def: ['音頻', 'audio'], opt: ['歌曲', 'song']}, doc: {def: ['文件', 'doc'], opt: ['書籍', 'book', '小說', 'novel']}, present: {def: ['簡報', 'presentation'], opt: ['投影片']}, sheet: {def: ['試算表', 'sheet'], opt: ['報表']}, rawdoc: {def: ['純文字', 'doc'], opt: ['書籍', 'book', '小說', 'novel', '程式碼', 'code', '網頁', 'web']}, url: {def: ['url', '網站'], opt: ['webpage', '論壇', 'youtube', '介紹', 'wiki', 'baidu', 'marvel db', 'comic vine']}};
