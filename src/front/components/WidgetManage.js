...
export default function WidgetManage({ uploadProgress, feedbackNumber, musicNumber }) {
    return (
        <div className="btn-group-vertical" id="widget-manage-section" style={{float: 'right', position: 'fixed', bottom: '50px', zIndex: WIDGET_BUTTON_ZINDEX}}>
            ...
            <WidgetButton name="Music" show={musicNumber > 0 ? true : false} progress={musicNumber} buttonType="primary" widget={MUSIC} />
        </div>
    )
}
