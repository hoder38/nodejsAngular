...
import { WIDGET_BUTTON_ZINDEX, UPLOAD, FEEDBACK, MUSIC, VIDEO, IMAGE } from '../constants'
import WidgetButton from './WidgetButton'

export default function WidgetManage({ uploadProgress, feedbackNumber, musicNumber, musicMore, videoNumber, videoMore, imageNumber, imageMore }) {
    return (
